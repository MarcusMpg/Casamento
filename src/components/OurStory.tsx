import nossaHistoria from "@/assets/Nossa-História.jpg";
      ...
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6 text-lg leading-relaxed text-foreground animate-slide-up">
            ...
            <p>
              ...
              um pouco receosa com a velocidade das coisas, hesitou por um
        ...
        <div className="mt-12 space-y-6 text-lg leading-relaxed text-foreground animate-slide-up">
          ...
          <p className="font-medium">
            ...
            emoção, que ele fez o tão esperado pedido de casamento — e ela, é
            claro, disse sim! 💍
          </p>
        </div>
      </div>
